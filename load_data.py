...
label_knn_pred = classify_knn(X_train[:,0:2], Y_train, X_test[:,0:2], Y_test, num_classes)
label_svm_pred = classify_svm(X_train[:,0:2], Y_train, X_test[:,0:2], Y_test, num_classes)
label_cnn_pred = classify_nn(X_train[:,0:2], Y_train, X_test[:,0:2], Y_test, num_classes)
